...
unsigned int sched_bore __read_mostly = 1;
unsigned int sched_burst_fork_atavistic __read_mostly = 1;
unsigned int sched_burst_cache_lifetime __read_mostly = 5000000;
unsigned int sched_burst_penalty_max __read_mostly = 200;
unsigned int sched_burst_smoothness __read_mostly = 100;
unsigned int sched_burst_penalty_scale __read_mostly = 20;
unsigned int sched_adaptive_embargo __read_mostly = 30;
